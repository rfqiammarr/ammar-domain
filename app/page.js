  ...
  return (
    <>
      <div className="flex flex-col items-center text-center">
        ...
        <h2 className="text-3xl font-semibold text-gray-600 dark:text-white mb-13 mt-28">My Project</h2>
        <div className="flex flex-wrap gap-6">
          <div className="w-full md:w-[calc(50%-0.75rem)] max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
              <img class="p-8 rounded-t-lg" src="https://images.klipfolio.com/website/public/bf9c6fbb-06bf-4f1d-88a7-d02b70902bd1/data-dashboard.png" alt="product image" />
            </a>
            <div class="px-5 pb-5">
              <a href="#">
