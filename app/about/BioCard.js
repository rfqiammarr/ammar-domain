      ...
      <div className="flex-1">
        ...
        <div className="">
          <p className="tracking-wide text-xl/8 font-normal text-gray-700 dark:text-gray-400 mb-4">
            Hello! 👋 I&rsquo;m Ammar, a Software Developer based in Bekasi 🇮🇩. I specialize in .NET development, and over the years I&apos;ve built solid experience with technologies like C#, Blazor, MS SQL Server, PostgreSQL, VB.NET,
            Next.js, Python, and JavaScript. Always eager to learn, solve real-world problems, and build clean, scalable software.
          </p>
          <p className="tracking-wide text-xl/8 font-normal text-gray-700 dark:text-gray-400 mb-4">
          ...
          <p className="tracking-wide text-xl/8 font-normal text-gray-700 dark:text-gray-400 mb-4">
            I&rsquo;m always open to collaboration, learning from others, or exploring exciting new opportunities. If you&rsquo;re working on something meaningful—or just want to connect—feel free to reach out! 🚀
          </p>
        </div>
      </div>
    </div>
